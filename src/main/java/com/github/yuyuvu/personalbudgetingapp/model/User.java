 ...
 * сохранением данных в файлы. <br>
 * В логике управления личными финансами используется только для получения экземпляра кошелька
 * (getWallet).
 */
...
public class User {
   ...
   * Метод для перевода значений полей, хранимых в объекте пользователя, в строку.
   */
  @Override
