...
/**
 * Класс для точки входа в приложение. Также отвечает за основной цикл вывода меню и обработки ввода пользователя. <br>
 * Хранит статические поля для текущего пользователя, текущего меню и сканера ввода, которые используются другими классами.
 */
public class PersonalBudgetingApp {
    ...
    public void start() {
        ...
        /* В процессе работы приложения в currentMenu через setCurrentMenu() подставляются наследники абстрактного
        * класса presentation.menus.Menu.
